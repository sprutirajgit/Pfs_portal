...
public class Portalken {
	public static Logger log = LogManager.getLogger(Portalken.class);
	...
	public  void TestVerify() throws InterruptedException {
       ...
       Thread.sleep(10000);
       Automate.CallXpath(driver, ActionXpath.prName, time);
       Thread.sleep(3000);
       Automate.CallXpath(driver, ActionXpath.profile, time);
       Thread.sleep(3000);
       Automate.CallXpath(driver, ActionXpath.OpenExpanEducation, time);
       Thread.sleep(3000);
       Automate.CallXpath(driver, ActionXpath.CloseExpanEducation, time);
       Thread.sleep(3000);
       driver.navigate().back();
       Thread.sleep(3000);
       Automate.CallXpath(driver, ActionXpath.Drawer, time);
       ...
       Automate.CallXpath(driver, ActionXpath.SelectPrtoSignout, time);
       Automate.CallXpath(driver, ActionXpath.signOut, time);
		}
